package com.galijz.manager_app.client;
...
public class RestClientProductsRestClient implements ProductsRestClient{
    ...
    private final ParameterizedTypeReference<List<Product>> PRODUCTS_TYPE_REFERENCE = new ParameterizedTypeReference<List<Product>>() {
    };
    ...
    public Optional<Product> findProduct(int productId) {
        try {
            return Optional.ofNullable(this.restClient.get()
                    ...
                    {throw new HttpClientErrorException(response.getStatusCode(), "Продукт не найден: "  + productId);}))
                    .body(Product.class));
